...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public Map createNative(String orderNo) {
        try {
            ...
            HttpClient client = new HttpClient("https://api.mch.weixin.qq.com" +
                    "/pay/unifiedorder");
            client.setXmlParam(WXPayUtil.generateSignedXml(m, "T6m9iK73b0kn9g5v4" +
                    "26MKfHQH7X8rKwb"));
    ...
    public void updateOrderStatus(Map<String, String> map) {
        ...
        Long buyCount = courseInfoOrder.getBuyCount();
        EduCourse eduCourse = new EduCourse();
        eduCourse.setId(courseId);
        eduCourse.setBuyCount(buyCount+1);
        eduClient.updateCourseCount(eduCourse);
